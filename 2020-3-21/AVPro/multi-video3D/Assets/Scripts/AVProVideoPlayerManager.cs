...
public class AVProVideoPlayerManager : MonoBehaviour
{
    ...
    //private string fileDir = "C:/chart/video/random";
    ...
    void Start()
    {
        for(int i=numOfVideosStart; i<numOfVideosEnd; i++)
        {
            ...
            //MakeVideoPlayer("chart-dpx_h265_" + i.ToString("00") + "_rh420-fastdecode.mp4");
            //MakeVideoPlayer("chart-dpx_h265_" + i.ToString("00") + "_rh420-zero.mp4");
            //MakeVideoPlayer("chart-dpx_h265_" + i.ToString("00") + "_rh444-fastdecode.mp4");
            //MakeVideoPlayer("chart-dpx_h265_" + i.ToString("00") + "_rh444-zero.mp4");
        }
    }
